...
export default function Notification({ message, type = 'info', duration = 3000, onClose }) {
  ...
  return (
    <div className={`fixed top-4 right-4 z-50 max-w-md ${isVisible ? 'animate-slide-up' : 'animate-fade-out'}`}>
      <div className={`bg-gradient-to-r ${getNotificationStyle(type)} rounded-xl shadow-2xl p-4 border border-white/20 backdrop-blur-lg`}>
